...
const form = useForm({
	custom_id: props.customer.custom_id,
...
const updateCustomer = () => {
    form.patch(route('customers.update',{customer:props.customer.id}),{
                ...
                <div class="p-content">
                    <div class="p-content__text">
						<div class="p-content__form">
                            <form @submit.prevent="updateCustomer" class="p-content__form">
