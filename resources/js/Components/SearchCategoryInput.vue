...
const categories = ref([]); // 検索結果を受け取りmodalで表示
const displayValue = ref(''); // 検索値と選択したcategoryのcustom_id
const selectedName = ref(''); // 選択したcategoryのname
...
onMounted(() => {
    ...
    if(props.selectedCategory){
        displayValue.value = props.selectedCategory.custom_id;
        selectedName.value = props.selectedCategory.name;
    }
});
...
const selectCategory = (category) => {
    ...
    displayValue.value = category.custom_id;
        ...
        <div v-show="!hasResults" class="p-table">
            <table class="p-content__table">
                ...
                <tr v-for="(category,index) in categories" :key="category.id" class="p-content__table--column"
                    ...
                    <td class="p-content__table--column-data">{{ category.custom_id }}</td>
                    <td class="p-content__table--column-data">{{ category.name }}</td>
                </tr>
            </table>
            <!-- <Pagination :links="categories.links" class="p-paginate" /> -->
        </div>
